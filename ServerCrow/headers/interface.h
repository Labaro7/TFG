...
public:
	...
	virtual void saveEmployee(const Employee& employee) = 0;
	...
	virtual void saveTableProduct(Table& table, const Product& product, const int& amount) = 0;
	...
	virtual Employee getEmployeeByName(const std::string name) = 0;
